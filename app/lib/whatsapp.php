...
class WhatsAppAPIClient
{
  ...
  public function sendMessageCustom($id_empresa, $id_orden, $phone, $msg)
  {
    ...
    $this->apiUrl = 'https://ws.nineteengreen.com/send-message-custom/' . $id_empresa;  // Asegúrate de que la URL sea correcta para enviar mensajes
  ...
  {
    $this->apiUrl = 'https://ws.nineteengreen.com/session-info/' . $id_empresa;
  ...
  public function sendDirectMessageToNode($id_empresa, $phone, $message)
  {
    ...
    $this->apiUrl = 'https://ws.nineteengreen.com/send-direct-message/' . $id_empresa;
    $payload = [
      'phone' => $phone,
      'message' => $message,
    ];
