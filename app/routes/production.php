...
return function (App $app) {
  ...
  $app->get('/sse/produccion/corte/{id_empleado}', function (Request $request, Response $response, array $args) {  // /lotes/en-proceso
    ...
    // La asignación real vive en lotes_detalles_empleados_asignados (LDEA),
    // a nivel orden+departamento (no por cada fila de lotes_detalles), así
    // que se filtra con EXISTS en vez de comparar directo por id_empleado.
    // ?todos=1: el Jefe de Producción no tiene tareas de corte asignadas a
    // sí mismo (su trabajo es asignárselas a otros) -- para ese caso se omite
    // el filtro por empleado y se devuelve el total de tareas de corte
    // pendientes de la empresa, no solo las de quien tiene la sesión abierta.
    ...
    $filtroEmpleado = $verTodos ? '' : "
                                                                                                                                                                                                                                                                                                                                                                        AND EXISTS (
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            AND dep.departamento = a.departamento
    ...
    $sql = "SELECT
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        WHERE
                                                                                                                                                                                                                                                                                                                                                                        a.departamento IN (SELECT departamento FROM departamentos WHERE tipo = 'corte')
