...
## [v1.0.55] - 2026-09-25
- Fix: Meta de insumos inflada en Eficiencia de Insumos (input-efficiency) al sumar todos los departamentos ya terminados en vez de solo el responsable de cada insumo
...
## [v1.0.52] - 2026-09-22
- Revert de columnas Dept/Comision en carga masiva general + nueva carga masiva de comisiones por departamento con plantilla pre-llenada
